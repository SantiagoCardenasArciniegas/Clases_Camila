---
title: "Tutorial de R con Base de datos Well Being"
...
```
## Otras formas de cargar paquetes
...
"Parc" es una variable con pocos niveles. Asumamos que la quiero tratar, no como una variable numérica, sino como una categórica. Es decir, como un factor. Voy a crear una segunda base para hacer la demostración.
...
# Correlaciones y Stargazer

### Correlación con NAS:

La columna space tiene NAS, entonces tengo que introducir el argumento "pairwise.complete.obs" en la función "Cor" para que no los considere al momento de computar la correlación.
...
#Para visualizar en R y en Markdown
...
#Para Exportar como objeto html para meter en word
...
### Summary Statistics con Stargazer: 

Stargazer solo funciona con Data Frames. Por ende es necesario utilizar as.data.frame. Con Tibbles No funciona.
...
Para las gráficas de correlación puede ser útil crear antes una nueva base sin la columna "Id"
...
### Corplots con diferentes paquetes
```{r,message=FALSE, warning=FALSE}   
...
Dos variables dependientes. Dos modelos distitnos

### Modelo 1. Variable dependiente: "SHS"

```{r}

#Modelo completo (M1 full)
...
# Modelo 1. Variable dependiente: "anxdep"

```{r}
#Modelo completo (M2 full)
